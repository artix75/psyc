...
psycl is a command-line interface to PsyC, an open-source C library that allows building neural networks ( [https://github.com/artix75/psyc](https://github.com/artix75/psyc) ).  The utility can be used to build, load, save and train models without the need to write a C program, albeit with limitations.  
